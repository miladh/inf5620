...
\PY{n}{A}\PY{p}{,}\PY{n}{B}\PY{p}{,}\PY{n}{b}\PY{p}{,}\PY{n}{w}\PY{p}{,}\PY{n}{kx}\PY{p}{,}\PY{n}{ky}\PY{p}{,} \PY{n}{q} \PY{o}{=} \PY{n}{symbols}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{A,B,b,w,k\PYZus{}x,k\PYZus{}y,q}\PY{l+s}{\PYZdq{}}\PY{p}{)}
\PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{,}\PY{n}{t} \PY{o}{=} \PY{n}{symbols}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{x,y,t}\PY{l+s}{\PYZdq{}}\PY{p}{)}
\PY{n}{u} \PY{o}{=} \PY{p}{(}\PY{n}{A}\PY{o}{*}\PY{n}{cos}\PY{p}{(}\PY{n}{w}\PY{o}{*}\PY{n}{t}\PY{p}{)}\PY{o}{+}\PY{n}{B}\PY{o}{*}\PY{n}{sin}\PY{p}{(}\PY{n}{w}\PY{o}{*}\PY{n}{t}\PY{p}{)}\PY{p}{)}\PY{o}{*}\PY{n}{exp}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{n}{b}\PY{o}{*}\PY{n}{t}\PY{p}{)}\PY{o}{*}\PY{n}{cos}\PY{p}{(}\PY{n}{kx}\PY{o}{*}\PY{n}{x}\PY{p}{)}\PY{o}{*}\PY{n}{cos}\PY{p}{(}\PY{n}{ky}\PY{o}{*}\PY{n}{y}\PY{p}{)}
\PY{n}{display}\PY{p}{(}\PY{n}{u}\PY{p}{)}
\end{Verbatim}
...
\begin{alltt}(A*cos(t*w) + B*sin(t*w))*exp(-b*t)*cos(k\_x*x)*cos(k\_y*y)\end{alltt}
...
\PY{n}{display}\PY{p}{(}\PY{n}{u\PYZus{}t}\PY{p}{)}
\end{Verbatim}
...
\PY{n}{display}\PY{p}{(}\PY{n}{u\PYZus{}tt}\PY{p}{)}
\end{Verbatim}
...
$$\left(A b^{2} \cos{\left (t w \right )} + 2 A b w \sin{\left (t w \right )} - A w^{2} \cos{\left (t w \right )} + B b^{2} \sin{\left (t w \right )} - 2 B b w \cos{\left (t w \right )} - B w^{2} \sin{\left (t w \right )}\right) e^{- b t} \cos{\left (k_{x} x \right )} \cos{\left (k_{y} y \right )}$$
    ...
    \needspace{4\baselineskip}
        ...
        \begin{ColorVerbatim}
            \vspace{-0.7\baselineskip}
            \begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{u\PYZus{}tt}\PY{o}{.}\PY{n}{subs}\PY{p}{(}\PY{n}{t}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{)}
\end{Verbatim}
...
$$\left(A b^{2} - A w^{2} - 2 B b w\right) \cos{\left (k_{x} x \right )} \cos{\left (k_{y} y \right )}$$
    ...
    \needspace{4\baselineskip}
        ...
        \begin{ColorVerbatim}
            \vspace{-0.7\baselineskip}
            \begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{u\PYZus{}t}\PY{o}{.}\PY{n}{subs}\PY{p}{(}\PY{n}{t}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{)}
\end{Verbatim}
...
\PY{n}{display}\PY{p}{(}\PY{n}{u\PYZus{}xx}\PY{p}{,}\PY{n}{u\PYZus{}yy}\PY{p}{)}
\end{Verbatim}
...
$$k_{y}^{2} \left(- A \cos{\left (t w \right )} - B \sin{\left (t w \right )}\right) e^{- b t} \cos{\left (k_{x} x \right )} \cos{\left (k_{y} y \right )}$$
    ...
    \needspace{4\baselineskip}
        ...
        \begin{ColorVerbatim}
            \vspace{-0.7\baselineskip}
            \begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{u\PYZus{}xx}\PY{o}{.}\PY{n}{subs}\PY{p}{(}\PY{n}{t}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{)}
\end{Verbatim}
...
$$- A k_{x}^{2} \cos{\left (k_{x} x \right )} \cos{\left (k_{y} y \right )}$$
    ...
    \needspace{4\baselineskip}
        ...
        \begin{ColorVerbatim}
            \vspace{-0.7\baselineskip}
            \begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{u\PYZus{}yy}\PY{o}{.}\PY{n}{subs}\PY{p}{(}\PY{n}{t}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{)}
\end{Verbatim}
...
\PY{n}{B\PYZus{}tmp} \PY{o}{=} \PY{n}{solve}\PY{p}{(}\PY{n}{V}\PY{p}{,}\PY{n}{B}\PY{p}{)}
\PY{n}{display}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{B = }\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{B\PYZus{}tmp}\PY{p}{)}
\PY{n}{ccode}\PY{p}{(}\PY{n}{V}\PY{p}{)}
\end{Verbatim}
...
$$\begin{bmatrix}\frac{A b}{w}\end{bmatrix}$$
            \end{InvisibleVerbatim}
                ...
                \vspace{-2.55\baselineskip}\begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}(-A*b + B*w)*cos(k\_x*x)*cos(k\_y*y)\end{alltt}
...
\PY{n}{eq\PYZus{}t0} \PY{o}{=} \PY{n}{eq}\PY{o}{.}\PY{n}{subs}\PY{p}{(}\PY{n}{B}\PY{p}{,}\PY{n}{B\PYZus{}tmp}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{subs}\PY{p}{(}\PY{n}{t}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{)}\PY{o}{.}\PY{n}{simplify}\PY{p}{(}\PY{p}{)}
\PY{n}{display}\PY{p}{(}\PY{n}{eq}\PY{p}{,} \PY{n}{eq\PYZus{}t0}\PY{p}{)}
\end{Verbatim}
...
$$A \left(- b^{2} + k_{x}^{2} q + k_{y}^{2} q - w^{2}\right) \cos{\left (k_{x} x \right )} \cos{\left (k_{y} y \right )}$$
    ...
    \needspace{4\baselineskip}
        ...
        \begin{ColorVerbatim}
            \vspace{-0.7\baselineskip}
            \begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{w\PYZus{}tmp} \PY{o}{=} \PY{n}{solve}\PY{p}{(}\PY{n}{eq\PYZus{}t0}\PY{p}{,}\PY{n}{w}\PY{p}{)}
\PY{n}{w\PYZus{}tmp}
\end{Verbatim}
...
\end{Verbatim}
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}<IPython.lib.display.YouTubeVideo at 0x283d610>\end{alltt}
...
$\Delta x = \Delta y = 0.01$:
    ...
    \needspace{4\baselineskip}
        ...
        \begin{ColorVerbatim}
            \vspace{-0.7\baselineskip}
            \begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{youTubeVideo}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{G\PYZus{}Pmdh\PYZhy{}uptU}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{width}\PY{o}{=}\PY{n}{youTubeWidth}\PY{p}{,} \PY{n}{height}\PY{o}{=}\PY{n}{youTubeHeight}\PY{p}{)}
\end{Verbatim}
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}<IPython.lib.display.YouTubeVideo at 0x283de10>\end{alltt}

            \end{InvisibleVerbatim}
            
                \begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\url{http://youtube.com/watch?v=G_Pmdh-uptU}
            \end{InvisibleVerbatim}
...
$\Delta x = \Delta y = 0.01$:
    ...
    \needspace{4\baselineskip}
        ...
        \begin{ColorVerbatim}
            \vspace{-0.7\baselineskip}
            \begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{youTubeVideo}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{IlQwI2azEfU}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{width}\PY{o}{=}\PY{n}{youTubeWidth}\PY{p}{,} \PY{n}{height}\PY{o}{=}\PY{n}{youTubeHeight}\PY{p}{)}
\end{Verbatim}
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \vspace{-2.55\baselineskip}\begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}<IPython.lib.display.YouTubeVideo at 0x26511d0>\end{alltt}
